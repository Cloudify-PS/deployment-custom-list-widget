  ...
  (0, _createClass3.default)(PluginsCatalogList, [{
    ...
    */
    ...
    value: function render() {
      ...
      var columns = this.props.widget.configuration.columnsToShow;
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          columns.includes('Blueprint') && React.createElement(DataTable.Column, { label: 'Blueprint', name: 'blueprint_id' }),
          columns.includes('Created') && React.createElement(DataTable.Column, { label: 'Created', name: 'created_at' }),
          columns.includes('Updated') && React.createElement(DataTable.Column, { label: 'Updated', name: 'updated_at' }),
          columns.includes('Creator') && React.createElement(DataTable.Column, { label: 'Creator', name: 'created_by' }),
          React.createElement(DataTable.Column, { width: '20%' }),
          this.props.data.items.map(function (item) {
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  { className: 'deploymentName', href: 'javascript:void(0)', onClick: function onClick() {
                      return _this3._selectDeployment(item);
                    } },
                  item.id
                ),
              ...
              React.createElement(
                DataTable.Data,
                { className: !columns.includes('Blueprint') ? 'none' : '' },
                item.blueprint_id
              ),
              React.createElement(
                DataTable.Data,
                { className: !columns.includes('Created') ? 'none' : '' },
                item.created_at
              ),
              React.createElement(
                DataTable.Data,
                { className: !columns.includes('Updated') ? 'none' : '' },
                item.updated_at
              ),
              React.createElement(
                DataTable.Data,
                { className: !columns.includes('Creator') ? 'none' : '' },
                item.created_by
              ),
              React.createElement(
                DataTable.Data,
                ...
                _.isEmpty(item.executions) ? React.createElement(
                  ...
                  React.createElement(
                    Button,
                    {
                      primary: true,
                      size: 'mini',
                      onClick: _this3.runExecution.bind(_this3, 'install', item)
                    },
                    'Approve'
                  ),
                  React.createElement(
                    Button,
                    {
                      size: 'mini',
                      color: 'red',
                      onClick: _this3.runExecution.bind(_this3, 'uninstall', item)
                    },
                    'Deny'
                  )
                ) : React.createElement(_ActiveExecutionStatus2.default, { item: item.executions[0], onCancelExecution: _this3._cancelExecution.bind(_this3) })
              )
            );
          })
        ),
